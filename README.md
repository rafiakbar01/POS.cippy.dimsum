...
Sistem Point of Sale (POS) Kasir & Rekap Keuntungan Cippy Dimsum modern, responsif mobile, dan user-friendly berbasis PHP Native 8.2 & Tailwind CSS.
...
1. Simpan folder di `d:\Laragon\www\CippyDimsum`
2. Buka browser: `http://localhost/CippyDimsum`

## 🌐 Deploy di Vercel
Dideploy dengan Vercel CLI atau via GitHub Repository:
`https://github.com/rafiakbar01/POS.cippy.dimsum.git`
